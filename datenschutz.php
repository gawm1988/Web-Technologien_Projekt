...
<title>Oldenburger Skulpturen - Datenschutz</title>
<link rel="stylesheet" type="text/css" href="./assets/css/rechtliches.css">
</head>
            ...
            <div class="legal-item">
                ...
                <div class="legal-info">
                    ...
                    <p>Ihre Daten werden zum
                        einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z.&nbsp;B. um
                        Daten handeln, die Sie in ein
                    ...
                    <p>Ein Teil der Daten wird erhoben, um eine
                        ...
                        Analyse Ihres
                        Nutzerverhaltens verwendet werden.</p> <h4>Welche Rechte haben Sie bez&uuml;glich Ihrer
                        Daten?</h4>
                ...
                <div class="legal-info">
                    ...
                    <p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:<br><br>
                        ...
                        26129 Oldenburg<br><br>
                        Vertreten durch:<br><br>
                        Julian Haase<br>
                        Telefon: +49 (0) 123 44 55 66<br>
                        E-Mail: julian.haase@uni-oldenburg.de<br><br>
                    ...
                    <p>Verantwortliche Stelle ist die nat&uuml;rliche oder juristische Person, die allein oder
                        ...
                        &uuml;ber die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten (z.&nbsp;B.
                        Namen, E-Mail-
                    ...
                    <p>Sofern Sie
                        in die Datenverarbeitung eingewilligt haben, verarbeiten wir Ihre personenbezogenen Daten
                        ...
                        Grundlage von &sect;
                        25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserf&uuml;llung
                        oder zur
                    ...
                    <p>Im Rahmen unserer Gesch&auml;ftst&auml;tigkeit
                        ...
                        Rechtsgrundlage die
                        Datenweitergabe erlaubt. Beim Einsatz von Auftragsverarbeitern geben wir personenbezogene
                        Daten unserer
                        Kunden nur auf Grundlage eines g&uuml;ltigen Vertrags &uuml;ber Auftragsverarbeitung weiter.
                        Im Falle einer
                    ...
                    <p>Sie haben das Recht, Daten, die wir auf Grundlage
                        Ihrer Einwilligung oder in Erf&uuml;llung eines Vertrags automatisiert verarbeiten, an sich
                        oder an einen Dritten in
                    ...
                    <p>Sie haben im Rahmen der geltenden gesetzlichen
                        ...
                        personenbezogenen
                        Daten, deren Herkunft und Empf&auml;nger und den Zweck der Datenverarbeitung und ggf. ein
                        Recht auf
                    ...
                    <p>Sie haben das Recht, die Einschr&auml;nkung der
                        Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Hierzu k&ouml;nnen Sie sich
                    ...
                    <ul>
                        <li>Wenn Sie die
                            ...
                            um dies zu &uuml;berpr&uuml;fen. F&uuml;r die Dauer der Pr&uuml;fung haben Sie das
                            Recht, die
                        ...
                        <li>Wenn Sie einen
                            ...
                            haben Sie das
                            Recht, die Einschr&auml;nkung der Verarbeitung Ihrer personenbezogenen Daten zu
                            verlangen.
                        </li>
                    </ul>
                    ...
                    <p>Diese Seite nutzt aus Sicherheitsgr&uuml;nden und zum Schutz
                        der &Uuml;bertragung vertraulicher Inhalte, wie zum Beispiel Bestellungen oder Anfragen, die
                        Sie an uns als
                ...
                <div class="legal-info">
                    ...
                    <p>Cookies haben verschiedene Funktionen. Zahlreiche Cookies sind technisch
                        notwendig, da bestimmte Webseitenfunktionen ohne diese nicht funktionieren w&uuml;rden (z.&nbsp;B.
                        die
                    ...
                    <p>Cookies, die zur Durchf&uuml;hrung des
                        ...
                        Funktionen
                        (z.&nbsp;B. f&uuml;r die Warenkorbfunktion) oder zur Optimierung der Website (z.&nbsp;B.
                        Cookies zur Messung
                        des Webpublikums) erforderlich sind (notwendige Cookies), werden auf Grundlage von Art. 6
                        Abs. 1 lit. f DSGVO
                    ...
                    <h2>4. Nutzung von Leaflet und Nominatim API zur Verwendung von OpenStreetMap</h2>

                    <div class="legal-info">
                        <p>Unsere Website verwendet die Leaflet-Bibliothek und die Nominatim-API, um interaktive Karten auf Basis von OpenStreetMap-Daten bereitzustellen. Diese Karten ermöglichen es, Standorte anzuzeigen, Wegbeschreibungen anzubieten und die Interaktion mit geografischen Informationen zu ermöglichen.</p>
                    <h3>Leaflet</h3>
                    <p><strong>Leaflet</strong> ist eine Open-Source-JavaScript-Bibliothek zur Darstellung von Karten und zur Unterstützung von Funktionen wie Markern, Pop-ups und Zoomsteuerungen. Die Leaflet-Bibliothek stellt die Schnittstelle zu den OpenStreetMap-Karten bereit und ermöglicht es uns, interaktive Karten direkt auf unserer Website einzubinden. Es werden keine personenbezogenen Daten direkt durch die Leaflet-Bibliothek erhoben oder verarbeitet.</p>
                    <h3>Nominatim</h3>
                    <p>Die <strong>Nominatim</strong> API wird genutzt, um Adressen in geografische Koordinaten (Geokodierung) und umgekehrt (Reverse-Geokodierung) umzuwandeln. Nominatim ist ein Dienst von OpenStreetMap, der die Adressdaten der OpenStreetMap-Datenbank verwendet, um geografische Informationen bereitzustellen. Die Nutzung der Nominatim API unterliegt bestimmten Nutzungsbedingungen, um eine faire Nutzung der OpenStreetMap-Ressourcen sicherzustellen.</p>
                    <p>Hinweis: Bei der Verwendung der Nominatim API werden Standortinformationen an die Nominatim-Server gesendet, um die entsprechenden Geokoordinaten zurückzugeben. Die API-Daten und die damit verbundenen Karten- und Standortdaten werden durch OpenStreetMap gemäß ihrer eigenen Datenschutzrichtlinien und Nutzungsbedingungen bereitgestellt.</p>
                    <h3>Datenschutz und Nutzungsbedingungen</h3>
                    <p>Bitte beachten Sie, dass OpenStreetMap und die Nominatim API von Dritten betrieben werden. Durch die Nutzung dieser Dienste auf unserer Website akzeptieren Sie die Nutzungsbedingungen und Datenschutzrichtlinien von OpenStreetMap und Nominatim. Weitere Informationen finden Sie in den Datenschutzhinweisen von <a href="https://wiki.osmfoundation.org/wiki/Privacy_Policy"><strong>OpenStreetMap</strong></a>.</p>
                </div>

                <i>Stand: 28. November 2024</i>
            </div>
        </div>
    </section>
